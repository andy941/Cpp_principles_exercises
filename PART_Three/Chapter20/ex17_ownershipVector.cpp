...
public:
	...
	void push_back(const T* val) { elem.push_back(val); owned.push_back(val); }
	void push_back(T* val) { elem.push_back(val); owned.push_back(val); }
...
int main() 
{
	...
	Tracer t {4444444};
	v.push_back(t);				// not added to owned, should be destroyed automatically
}
